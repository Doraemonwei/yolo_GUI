...
def parse_opt(image_path, pic_save_path, model_name):
    ...
    parser.add_argument('--project', default=pic_save_path, help='save results to project/name')
...
if __name__ == "__main__":
    opt = parse_opt(
        image_path=r'D:\01Pycharm\Project\QT_Project\target_detection\yolo\data\images\zidane.jpg',
